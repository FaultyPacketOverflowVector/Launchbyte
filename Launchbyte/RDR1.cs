...
public class RDR1 : Form
{
	...
	private void BypassGameBtn_Click(object sender, EventArgs e)
	{
		...
		folderDialog.Description = "Select RDR1 folder";
		if (folderDialog.ShowDialog() != DialogResult.OK)
		{
			return;
		}
		string selectedPath = folderDialog.SelectedPath;
		string gameExePath = Path.Combine(selectedPath, "RDR1.exe");
		...
		string downloadedFilePath = Path.Combine(tempFolder, "rdr1bypass.exe");
		string downloadUrl = "https://github.com/uxqc/L4unch3rH0sting/raw/main/rdr1bypass.exe";
		try
		{
		...
		{
			MessageBox.Show("Failed to download rdr1bypass.exe: " + ex.Message, "Download Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
			return;
		}
		...
		{
			MessageBox.Show("Failed to execute or delete gta1bypass.exe: " + ex2.Message, "Execution Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
		}
	}
	...
	private void AddToSteamBtn_Click(object sender, EventArgs e)
	{
		...
		string[] manifestUrls = new string[2] { "https://github.com/uxqc/m4n1f3st/raw/main/2668510/2668511_870294950404908569.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/2668510/2668512_1315505799720334590.manifest" };
		using (WebClient client = new WebClient())
		{
		...
		string stFileUrl = "https://github.com/uxqc/m4n1f3st/raw/main/2668510/2668510.st";
		string stFilePath = Path.Combine(stpluginPath, "2668510.st");
	...
	private void LaunchGameBtn_Click(object sender, EventArgs e)
	{
		try
		{
			if (Process.GetProcessesByName("Steam").Any())
			{
				...
				{
					FileName = "steam://rungameid/2668510",
			...
			{
				Filter = "RDR1 Executable|PlayRDR.exe",
				Title = "Select RDR 1 Installation",
				InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86),
				FileName = "PlayRDR.exe"
			};
			if (openFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				{
					MessageBox.Show("Could not find PlayRDR.exe at the specified location!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
				}
			}
		}
		catch (Exception ex)
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Launchbyte.RDR1));
		...
		this.GamePanel.BackgroundImage = Launchbyte.Properties.Resources.rdr1;
