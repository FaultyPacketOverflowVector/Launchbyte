...
public class GTAIV : Form
{
	...
	private void BypassGameBtn_Click(object sender, EventArgs e)
	{
		...
		folderDialog.Description = "Select GTASA folder";
		if (folderDialog.ShowDialog() != DialogResult.OK)
		{
			return;
		}
		string selectedPath = folderDialog.SelectedPath;
		string gameExePath = Path.Combine(selectedPath, "PlayGTASanAndreas.exe");
		...
		string downloadedFilePath = Path.Combine(tempFolder, "gtasabypass.exe");
		string downloadUrl = "https://github.com/uxqc/L4unch3rH0sting/blob/main/gtasabypass.exe";
		try
		{
		...
		{
			MessageBox.Show("Failed to download gtasabypass.exe: " + ex.Message, "Download Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
			return;
		}
		...
		{
			MessageBox.Show("Failed to execute or delete gtasabypass.exe: " + ex2.Message, "Execution Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
		}
	}
	...
	private void AddToSteamBtn_Click(object sender, EventArgs e)
	{
		...
		string[] manifestUrls = new string[8] { "https://github.com/uxqc/m4n1f3st/raw/main/12210/12211_8070600747380932868.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12212_5029883714475696364.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12213_7959739752369022030.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12214_8513070578700495865.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12215_5596831668192471551.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12216_716802607004606457.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12217_703090685957058760.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/12210/12218_5435507331887440070.manifest" };
		using (WebClient client = new WebClient())
		{
		...
		string stFileUrl = "https://github.com/uxqc/m4n1f3st/raw/main/12210/12210.st";
		string stFilePath = Path.Combine(stpluginPath, "12210.st");
	...
	private void LaunchGameBtn_Click(object sender, EventArgs e)
	{
		try
		{
			if (Process.GetProcessesByName("Steam").Any())
			{
				...
				{
					FileName = "steam://rungameid/12210",
			...
			{
				Filter = "GTA IV Executable|PlayGTAIV.exe",
				Title = "Select GTA IV Installation",
				InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86),
				FileName = "PlayGTAIV.exe"
			};
			if (openFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				{
					MessageBox.Show("Could not find PlayGTAIV.exe at the specified location!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
				}
			}
		}
		catch (Exception ex)
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Launchbyte.GTAIV));
		...
		this.GamePanel.BackgroundImage = Launchbyte.Properties.Resources.gtaiv;
