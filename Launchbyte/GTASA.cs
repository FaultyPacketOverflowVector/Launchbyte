...
public class GTASA : Form
{
	...
	private void AddToSteamBtn_Click(object sender, EventArgs e)
	{
		...
		string[] manifestUrls = new string[1] { "https://github.com/uxqc/m4n1f3st/raw/main/1547000/1547001_6814041191190748315.manifest" };
		...
		string stFileUrl = "https://github.com/uxqc/m4n1f3st/raw/main/1547000/1547000.st";
		string stFilePath = Path.Combine(stpluginPath, "1547000.st");
	...
	private void LaunchGameBtn_Click(object sender, EventArgs e)
	{
		try
		{
			if (Process.GetProcessesByName("Steam").Any())
			{
				...
				{
					FileName = "steam://rungameid/1547000",
			...
			{
				Filter = "GTA SA Executable|PlayGTASanAndreas.exe",
				Title = "Select GTA V Installation",
				InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86),
				FileName = "PlayGTASanAndreas.exe"
			};
			if (openFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				{
					MessageBox.Show("Could not find PlayGTASanAndreas.exe at the specified location!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
				}
			}
		}
		catch (Exception ex)
	...
	private void BypassGameBtn_Click(object sender, EventArgs e)
	{
		...
		string gameExePath = Path.Combine(selectedPath, "SanAndreas.exe");
		...
		string downloadUrl = "https://github.com/uxqc/L4unch3rH0sting/raw/main/gtasabypass.exe";
		try
		{
			using WebClient client = new WebClient();
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Launchbyte.GTASA));
		...
		this.GamePanel.BackgroundImage = Launchbyte.Properties.Resources.gtasa;
