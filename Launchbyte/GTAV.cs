...
public class GTAV : Form
{
	...
	private void BypassGameBtn_Click(object sender, EventArgs e)
	{
		...
		folderDialog.Description = "Select GTAV folder";
		if (folderDialog.ShowDialog() != DialogResult.OK)
		{
			return;
		}
		string selectedPath = folderDialog.SelectedPath;
		string gameExePath = Path.Combine(selectedPath, "GTAV.exe");
		...
		string downloadedFilePath = Path.Combine(tempFolder, "gtavbypass.exe");
		string downloadUrl = "https://github.com/uxqc/L4unch3rH0sting/raw/main/gtavbypass.exe";
		try
		{
		...
		{
			MessageBox.Show("Failed to download gtavbypass.exe: " + ex.Message, "Download Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
			return;
		}
	...
	private void AddToSteamBtn_Click(object sender, EventArgs e)
	{
		...
		string[] manifestUrls = new string[6] { "https://github.com/uxqc/m4n1f3st/raw/main/271590/1899671_424738606525145871.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/271590/271591_4148712806132596056.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/271590/271592_6895113908287539233.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/271590/271593_6533191187872171909.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/271590/271594_8496545153343461683.manifest", "https://github.com/uxqc/m4n1f3st/raw/main/271590/271595_4898511214642125194.manifest" };
		using (WebClient client = new WebClient())
		{
		...
		string stFileUrl = "https://github.com/uxqc/m4n1f3st/raw/main/271590/271590.st";
		string stFilePath = Path.Combine(stpluginPath, "271590.st");
	...
	private void LaunchGameBtn_Click(object sender, EventArgs e)
	{
		try
		{
			...
			{
				Filter = "GTA V Executable|PlayGTAV.exe",
				Title = "Select GTA V Installation",
				InitialDirectory = Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86),
				FileName = "PlayGTAV.exe"
			};
			if (openFileDialog.ShowDialog() == DialogResult.OK)
			{
				...
				{
					MessageBox.Show("Could not find PlayGTAV.exe at the specified location!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
				}
			}
		}
		catch (Exception ex)
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Launchbyte.GTAV));
		...
		this.GamePanel.BackgroundImage = Launchbyte.Properties.Resources.gtav;
